(() => {
  ...
  if (isAccessoryCatalog && !document.getElementById("accessory-catalog-card-style")) {
    ...
    style.textContent = "body.accessory-catalog-page .iphone-grid{grid-template-columns:repeat(auto-fit,minmax(240px,1fr))!important;gap:14px!important;border:0!important}body.accessory-catalog-page .pl-catalog-card{height:420px!important;border:1px solid #e7edf5!important;border-radius:16px!important}body.accessory-catalog-page .pl-catalog-card .iphone-card-image{height:205px!important;min-height:205px!important;flex-basis:205px!important}@media(max-width:640px){body.accessory-catalog-page .iphone-grid{grid-template-columns:repeat(2,minmax(0,1fr))!important;gap:9px!important}body.accessory-catalog-page .pl-catalog-card{height:380px!important}body.accessory-catalog-page .pl-catalog-card .iphone-card-image{height:175px!important;min-height:175px!important;flex-basis:175px!important}}";
    document.head.appendChild(style);
  }
