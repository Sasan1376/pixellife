(() => {
  ...
  if (!document.getElementById("database-catalog-image-style")) {
    ...
    style.textContent = ".pl-catalog-card{display:flex!important;flex-direction:column;min-width:0;min-height:500px;padding:14px!important;background:#fff;border:1px solid #e7edf5!important;border-radius:16px!important;box-shadow:0 4px 16px rgba(15,23,42,.045);overflow:hidden;transition:transform .2s ease,box-shadow .2s ease,border-color .2s ease!important}.pl-catalog-card:hover{transform:translateY(-3px);border-color:#cbdcf7!important;box-shadow:0 12px 28px rgba(15,23,42,.11)}.pl-catalog-media,.pl-catalog-image,.pl-catalog-card .iphone-card-image,.pl-catalog-card .samsung-card-image,.pl-catalog-card .xiaomi-card-image,.pl-catalog-card .prod-card-image,.pl-catalog-card .xiaomitab-card-image,.pl-catalog-card .console-card-image{height:285px!important;min-height:285px!important;display:flex!important;align-items:center!important;justify-content:center!important;margin:0 0 14px!important;padding:16px!important;background:#fff!important;border-radius:12px!important;overflow:hidden;position:relative!important}.pl-catalog-media img,.pl-catalog-image img,.pl-catalog-card .iphone-card-image img,.pl-catalog-card .samsung-card-image img,.pl-catalog-card .xiaomi-card-image img,.pl-catalog-card .prod-card-image img,.pl-catalog-card .xiaomitab-card-image img,.pl-catalog-card .console-card-image img{width:100%!important;height:100%!important;max-width:100%!important;max-height:100%!important;object-fit:contain!important;display:block}.pl-catalog-body{display:flex;flex:1;min-width:0;flex-direction:column;padding:0 2px}.pl-catalog-brand{font-size:12px;color:#64748b;margin-bottom:5px}.pl-catalog-card .iphone-card-name,.pl-catalog-card .samsung-card-name,.pl-catalog-card .xiaomi-card-name,.pl-catalog-card .prod-card-name,.pl-catalog-card .xiaomitab-card-name,.pl-catalog-card .console-card-name,.pl-catalog-card .card-name{font-size:15px!important;font-weight:800!important;line-height:1.85!important;min-height:54px;color:#172033!important;overflow:hidden;display:-webkit-box!important;-webkit-line-clamp:2;-webkit-box-orient:vertical}.pl-catalog-card .iphone-card-desc,.pl-catalog-card .samsung-card-desc,.pl-catalog-card .xiaomi-card-desc,.pl-catalog-card .prod-card-desc,.pl-catalog-card .xiaomitab-card-desc,.pl-catalog-card .console-card-desc{font-size:12px!important;line-height:1.8!important;color:#718096!important;min-height:42px;margin:6px 0 10px!important;overflow:hidden;display:-webkit-box!important;-webkit-line-clamp:2;-webkit-box-orient:vertical}.pl-catalog-color-dots{position:absolute;top:12px;left:12px;display:flex;flex-direction:column;gap:6px;z-index:2}.pl-catalog-color-dot{width:10px;height:10px;border-radius:50%;border:1px solid rgba(15,23,42,.18);box-shadow:0 1px 2px rgba(15,23,42,.18)}.pl-catalog-footer{display:flex;align-items:center;justify-content:space-between;gap:8px;margin-top:auto;padding-top:10px;border-top:1px solid #f0f3f7}.pl-catalog-status{display:inline-flex;align-items:center;gap:5px;font-size:12px;font-weight:700;white-space:nowrap}.pl-catalog-status.in{color:#16803a}.pl-catalog-status.out{color:#c2413a}.pl-catalog-price{font-size:14px;font-weight:800;color:#172033;white-space:nowrap}.pl-catalog-loading{grid-column:1/-1;min-height:180px;display:grid;place-items:center;color:#64748b;font:600 14px Vazirmatn,Tahoma,sans-serif;background:#f8fafc;border:1px solid #e2e8f0;border-radius:14px}@media(max-width:640px){.pl-catalog-card{min-height:430px;padding:10px!important;border-radius:14px!important}.pl-catalog-media,.pl-catalog-image,.pl-catalog-card .iphone-card-image,.pl-catalog-card .samsung-card-image,.pl-catalog-card .xiaomi-card-image,.pl-catalog-card .prod-card-image,.pl-catalog-card .xiaomitab-card-image,.pl-catalog-card .console-card-image{height:225px!important;min-height:225px!important;padding:10px!important;margin-bottom:10px!important}.pl-catalog-card .iphone-card-name,.pl-catalog-card .samsung-card-name,.pl-catalog-card .xiaomi-card-name,.pl-catalog-card .prod-card-name,.pl-catalog-card .xiaomitab-card-name,.pl-catalog-card .console-card-name,.pl-catalog-card .card-name{font-size:13px!important;min-height:48px}.pl-catalog-price{font-size:13px}}";
