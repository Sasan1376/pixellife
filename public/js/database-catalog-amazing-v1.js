(() => {
  ...
  if (isAccessoryCatalog && !document.getElementById("accessory-catalog-card-style")) {
    ...
    style.textContent = "body.accessory-catalog-page .iphone-grid{grid-template-columns:repeat(auto-fill,minmax(210px,1fr))!important;gap:0!important;border:0!important;background:#fff!important}body.accessory-catalog-page .pl-catalog-card{height:480px!important;border:0!important;border-inline-end:1px solid #e5e7eb!important;border-block-end:1px solid #e5e7eb!important;border-radius:0!important}body.accessory-catalog-page .pl-catalog-card .iphone-card-image{height:250px!important;min-height:250px!important;flex-basis:250px!important}@media(max-width:640px){body.accessory-catalog-page .iphone-grid{grid-template-columns:repeat(2,minmax(0,1fr))!important;gap:0!important}body.accessory-catalog-page .pl-catalog-card{height:415px!important}body.accessory-catalog-page .pl-catalog-card .iphone-card-image{height:205px!important;min-height:205px!important;flex-basis:205px!important}}";
    document.head.appendChild(style);
  }
